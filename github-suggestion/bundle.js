(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(require('ramda'), require('rxjs'), require('whatwg-fetch')) :
	typeof define === 'function' && define.amd ? define(['ramda', 'rxjs', 'whatwg-fetch'], factory) :
	(factory(global.R,global.Rx,global.fetch));
}(this, (function (R,Rx,fetch) { 'use strict';
...
refreshClick$.subscribe(a => console.log(a));
// 请求刷新流，来自于点击刷新流产生
